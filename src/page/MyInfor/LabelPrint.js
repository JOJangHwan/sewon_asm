...
<div className="info-section">
  <img
    ...
    onLoad={handleLogoLoad}
  />
  <div className="text-line main-location">{asset.company} {asset.department} {asset.location}</div>
  <div className="text-line barcode-text">{asset.barcode}</div>
  <div className="text-line item-name">{asset.itemName}</div>
</div>
