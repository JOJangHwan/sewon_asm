// export function filterItems(items, { company, department, location, assetCategory, item, startDate, endDate, sortField, sortOrder }) {
...
//       return matchCompany && matchDepartment && matchLocation && matchAssetCategory && matchItem && matchStartDate && matchEndDate;
//     });
